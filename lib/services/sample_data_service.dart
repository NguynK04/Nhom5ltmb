...
class SampleDataService {
  ...
  // Thêm dữ liệu mẫu categories và products
  Future<void> addSampleData() async {
    try {
      ...
      for (final category in categories) {
        ...
        print('✅ Đã thêm category: ${category['name']} - ID: ${docRef.id}');
      }

      print('📊 Đã tạo ${categoryIds.length} categories');
      ...
      final products = [
        ...
        },
        {
          'name': 'Chả Cá Nướng',
          'description':
              'Chả cá tự làm nướng than hoa, thơm béo đậm đà hương vị',
          'price': 120000.0,
          'categoryName': 'Món Nướng',
          'stock': 40,
          'unit': 'phần',
        ...
        },
        {
          'name': 'Trái Cây Dĩa',
          'description':
              'Dĩa trái cây tươi theo mùa: xoài, dứa, nho, táo, lê...',
          'price': 80000.0,
          'categoryName': 'Tráng Miệng',
          'stock': 20,
          'unit': 'dĩa',
      ...
      for (final product in products) {
        ...
        if (categoryId != null) {
          ...
          addedProductCount++;
          print('✅ Đã thêm product: ${product['name']} - ID: ${docRef.id}');
        } else {
          print('❌ Không tìm thấy categoryId cho: ${product['categoryName']}');
        }
      }

      print('🎉 Hoàn thành! Đã thêm $addedProductCount products');
    } catch (e) {
      throw Exception('Lỗi thêm dữ liệu mẫu: $e');
    }
  }
